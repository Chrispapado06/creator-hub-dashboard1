 ...
 * row. Nobody is NOTIFIED — there is no trigger and no notification table — but
 * this is not a private bookmark, and the difference matters to somebody
 * deciding whether to follow a stranger.
 */
const FOLLOW_MEANING =
  "Kept on your ICEFALL account. Nobody is notified, and no feed reads this list yet — following somebody does not change what you see. Their account can read who follows it, so this is not a private bookmark.";
 ...
 * could make.
 */
type FollowState = { kind: "unavailable" } | { kind: "ready"; following: boolean };

function useFollow(profileId: string | null, myId: string | null) {
