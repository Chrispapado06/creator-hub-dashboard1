/*
 * THE PREVIOUS HOME, KEPT ON PURPOSE (2026-09-16).
 *
 * The owner asked for Home to be rebuilt 1:1 to the eight-state mockup boards
 * and, in the same message, for this version to be saved "in case i dont like
 * new one". This file is that copy, unchanged apart from the component name.
 * It is reachable at /home/classic and from Settings → Home layout. Delete it
 * only once the owner has said the new Home stays.
 */
...
import ReadyForNoSignalCard from "@/components/domain/ReadyForNoSignalCard";
import {
  fmtCountdown,
  fmtDistance,
  fmtElevation,
  ...
  return (
    <Screen padded={false}>
      ...
      <Stagger className="px-5">
        {/* Renders nothing outside the week before a trip, or once everything on
            the checklist is done. See `ReadyForNoSignalCard`. */}
        <ReadyForNoSignalCard className="pt-3" />
