...
// `icefall-supabase/supabase/functions/health/types.ts` and the two must stay
// byte-for-byte identical below the import line. A typo then becomes a compile
// error on one side rather than a silent fall-through on both.
//
