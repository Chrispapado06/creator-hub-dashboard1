...
/**
 * Shown ONCE, on Home, in one line.
 *
...
export const CLIENTS: Client[] = OFFLINE
  ...
  ? []
  : [
      { id: "c1", name: "Nima Dorjee", email: "nima.dorjee@example.com", phone: "+977 98123 45678", from: "Kathmandu, Nepal", online: true, notes: "Prefers gradual acclimatization and good food on treks." },
      { id: "c2", name: "Sara Khumbu", email: "sara.khumbu@example.com", phone: "+977 98455 21100", from: "Namche, Nepal", online: true, notes: "Strong on rock, less confident on steep snow." },
      { id: "c3", name: "Jason Wong", email: "jason.wong@example.com", phone: "+65 8123 4455", from: "Singapore", online: false, notes: "First 6,000 m peak last season. Wants Ama Dablam next." },
      { id: "c4", name: "Michelle Lee", email: "michelle.lee@example.com", phone: "+1 415 555 0182", from: "San Francisco, USA", online: true, notes: "Asks for the gear list early. Vegetarian." },
      { id: "c5", name: "David Thompson", email: "d.thompson@example.com", phone: "+44 7700 900321", from: "Edinburgh, Scotland", online: false, notes: "Winter Scottish background. Very fit, low altitude experience." },
      { id: "c6", name: "Lhakpa Sherpa", email: "lhakpa@example.com", phone: "+977 98511 33220", from: "Lukla, Nepal", online: false, notes: "Has climbed with me four seasons running." },
    ];
...
export const visibleApplication = (): GuideApplication =>
  sample(APPLICATION, EMPTY_APPLICATION);
  ...
  : [
      {
        ...
        unread: 2,
        messages: [
          { id: "m1", fromClientId: null, body: "Hello Nima! How is everything going at base camp?", at: hoursAgo(50) },
          { id: "m2", fromClientId: "c1", body: "Hi Alex! We just arrived in Namche. All good here.", at: hoursAgo(9) },
          { id: "m3", fromClientId: "c1", body: "The teahouse has hot showers, which nobody warned me about.", at: hoursAgo(8) },
        ],
      },
      {
        id: "t2",
        ...
        unread: 1,
        messages: [
          { id: "m4", fromClientId: "c2", body: "Perfect! See you tomorrow morning.", at: hoursAgo(26) },
        ],
      },
      {
        id: "t3",
        ...
        unread: 3,
        messages: [
          { id: "m5", fromClientId: "c3", body: "Alex: Don't forget to bring spare gloves.", at: hoursAgo(30) },
          { id: "m6", fromClientId: "c4", body: "Is the hut booked for the Friday night?", at: hoursAgo(28) },
          { id: "m7", fromClientId: "c5", body: "I have the crampons sorted, borrowed a pair.", at: hoursAgo(27) },
        ],
      },
      {
        id: "t4",
        ...
        unread: 0,
        messages: [
          { id: "m8", fromClientId: "c3", body: "Thanks for an amazing experience!", at: hoursAgo(50) },
          { id: "m9", fromClientId: null, body: "Any time — you moved really well on the ridge.", at: hoursAgo(48) },
        ],
      },
      {
        id: "t5",
        ...
        unread: 0,
        messages: [
          { id: "m10", fromClientId: "c6", body: "The weather looks stable for the summit window.", at: hoursAgo(52) },
        ],
      },
      {
        id: "t6",
        ...
        unread: 0,
        messages: [
          { id: "m11", fromClientId: "c4", body: "Could you share the gear list again?", at: hoursAgo(74) },
          { id: "m12", fromClientId: null, body: "Sent — it is in the trip notes as well.", at: hoursAgo(72) },
        ],
      },
      {
        id: "t7",
        ...
        unread: 0,
        messages: [
          { id: "m13", fromClientId: "c1", body: "Hi team! We just arrived in Namche. All good here.", at: hoursAgo(9) },
          { id: "m14", fromClientId: null, body: "Great to hear! Take rest and stay hydrated.", at: hoursAgo(8.7) },
          { id: "m15", fromClientId: "c2", body: "Perfect! See you all tomorrow morning.", at: hoursAgo(8.4) },
...
export const DAY_STATES: Record<string, DayState> = OFFLINE
  ...
  : (() => {
      ...
      for (const b of [{ f: 14, t: 27 }, { f: 40, t: 54 }]) {
