...
import { AnalyticsScopeSwitch } from "../_components/scope-switch";
    ...
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="space-y-1">
          <h1 className="text-3xl tracking-tight">App analytics</h1>
          <p className="text-muted-foreground text-sm">Traffic, engagement and conversion inside the ICEFALL phone app.</p>
        </div>
        <AnalyticsScopeSwitch active="app" />
      </div>
