import { handleSupport } from "./_support.mjs";

/**
 * POST /api/support — production transport.
 *
 * All behaviour lives in `_support.mjs`, which the local dev server runs too.
 * This file's only job is Vercel's request/response shape. Identical in
 * structure to `waitlist.js` on purpose — see the note in `_support.mjs`.
 */
